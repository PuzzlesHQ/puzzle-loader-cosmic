...
public class CommonSidedModelLoader implements ISidedModelLoader {
        ...
        for (int x = 360; x > -1; x -= 90) {
            for (int y = 360; y > -1; y -= 90) {
                for (int z = 360; z > -1; z -= 90) {
                    ...
                    floats[1] = y;
                    floats[2] = z;
                    DummyBlockModel.getInstanceFromJsonStr(modelGenerator.getName(), modelGenerator.toString(), floats);
                }
            }
        }
    }
